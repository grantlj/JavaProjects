...
public class submiter {
	...
	public static void initProgram()
	{
	  for (int i=0;i<7;i++)
		time[i]=false;
	  UI.jlPro.setText("Program initialized.");
	  UI.jlPro.setForeground(Color.GRAY);
	}
	...
	public static boolean login()
	{
		  ...
		  pwd=pwd.toUpperCase();
		  return new  MemberSets().inNameList(username, pwd);
  ...
  public static void initFtp()
	{
		ftp=new FtpUtil();
		UI.jlFTP.setText("Ftp client initialized.");
		UI.jlFTP.setForeground(Color.GRAY);
	}
   ...
   */
	public static void connectFtp()
	{
		...
		UI.jlFTP.setText("Ftp connected successful.");
		UI.jlFTP.setForeground(Color.GRAY);
	}
   ...
   */
	public static void getInfoFromFtp()
	{
		try {
			...
			UI.jf.setSize(447, 310);
			UI.jbUpl.setEnabled(true);
			UI.jbDl.setEnabled(false);
			UI.jcbSatM.setEnabled(true);
			UI.jcbSatA.setEnabled(true);
			UI.jcbSatN.setEnabled(true);
			UI.jcbSunM.setEnabled(true);
			UI.jcbSunA.setEnabled(true);
	...
	{
		UI.jlweek.setText("Week:"+week);
		UI.jllectrue.setText("Lecturer:"+lecture);
		UI.jllesson.setText("Lesson:"+lesson);
	}
